...
import { Data, FallbackType, ParamsType } from '../../typings';


export default function Page({ fallback }: { fallback: FallbackType }) {
    const router = useRouter()
    const { postId } = router.query;
    const { data, isLoading, isError }: { data: Data; isLoading: boolean; isError: boolean } = fetcher(`api/posts/${postId}`)
...
export async function getStaticPaths() {
    ...
    const paths = posts.map((value: Data) => {
        return {
            params: {
